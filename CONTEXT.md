...
- **Presenter view** reflows to its viewport; it is not a fixed canvas. This **Slide**'s **Speech** is the primary surface; previews of this **Slide** and the next are secondary. **Presenter view** shows this **Slide**'s **Speech** only; advance replaces it. Overflow scrolls. It is not mirrored. Previews of a **Slide** are that **Slide** as the audience viewport sees it — laid out at the audience size, then scaled. An **Embed** in a preview is not live.
